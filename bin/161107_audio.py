...
if __name__ == '__main__':
  ...
  filter_defs.filtering('L1_BHNS_+0Hz_passed.wav',source1,goldenL,lowpass=30,highpass=400,freqshift=0)
  filter_defs.filtering('L1_BHNS_+60Hz_passed.wav',source1,goldenL,lowpass=30,highpass=400,freqshift=60)
  filter_defs.filtering('L1_BNS_+0Hz_passed.wav',source2,goldenL,lowpass=30,highpass=1000,freqshift=0)
  filter_defs.filtering('L1_BNS_+60Hz_passed.wav',source2,goldenL,lowpass=30,highpass=1000,freqshift=60)
  filter_defs.filtering('H1_BNS_+0Hz_passed.wav',source3,goldenH,lowpass=30,highpass=1000,freqshift=0)
  filter_defs.filtering('H1_BNS_+60Hz_passed.wav',source3,goldenH,lowpass=30,highpass=1000,freqshift=60)
