...
if __name__ == '__main__':
  ...
  filter_defs.filtering('L1_BHNS_+0Hz_passed_2.wav',source1,goldenL,lowpass=400,highpass=80,freqshift=0)
  filter_defs.filtering('L1_BHNS_+60Hz_passed_2.wav',source1,goldenL,lowpass=400,highpass=80,freqshift=60)
  filter_defs.filtering('L1_BNS_+0Hz_passed_2.wav',source2,goldenL,lowpass=1000,highpass=120,freqshift=0)
  filter_defs.filtering('L1_BNS_+60Hz_passed_2.wav',source2,goldenL,lowpass=1000,highpass=120,freqshift=60)
  filter_defs.filtering('H1_BNS_+0Hz_passed_2.wav',source3,goldenH,lowpass=1000,highpass=120,freqshift=0)
  filter_defs.filtering('H1_BNS_+60Hz_passed_2.wav',source3,goldenH,lowpass=1000,highpass=120,freqshift=60)
  
  filter_defs.filtering('L1_BHNS_+0Hz_passed.wav',source1,goldenL,lowpass=400,highpass=30,freqshift=0)
  filter_defs.filtering('L1_BHNS_+60Hz_passed.wav',source1,goldenL,lowpass=400,highpass=30,freqshift=60)
  filter_defs.filtering('L1_BNS_+0Hz_passed.wav',source2,goldenL,lowpass=1000,highpass=30,freqshift=0)
  filter_defs.filtering('L1_BNS_+60Hz_passed.wav',source2,goldenL,lowpass=1000,highpass=30,freqshift=60)
  filter_defs.filtering('H1_BNS_+0Hz_passed.wav',source3,goldenH,lowpass=1000,highpass=30,freqshift=0)
  filter_defs.filtering('H1_BNS_+60Hz_passed.wav',source3,goldenH,lowpass=1000,highpass=30,freqshift=60)
